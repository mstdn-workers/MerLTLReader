...
import jp.zero_x_d.workaholic.merltlreader.engine.BouyomiConnecter
...
object MerLTLReader {
    ...
    @JvmStatic fun main(args: Array<String>) {
        preferences = Preferences.fromArgs({
            appName = MerLTLReader.appName
            baseDir = MerLTLReader.appDir
        }, *args)
        ITTSEngine.engines += mapOf(
                "bouyomi" to BouyomiConnecter(emptyMap()),
                "jtalk" to JTalkConnecter(emptyMap())
        )
